                        ...
                        CupertinoSwitch(
                          ...
                          onChanged: (value) {
                            gameController.isDarkTheme.value =
                                !gameController.isDarkTheme.value;
                            if (gameController.isDarkTheme.value) {
                              AnalyticsController().logThemeChoice();
                            } else {
                              AnalyticsController().logThemeChoice(
                                  isDarkTheme: "no", isLightTheme: "yes");
                            }
                          ...
                          KeyChar(
                            ...
                            onTap: () {
                              ...
                              if (gameController.round.value >= 3 &&
                                  !gameController.isGameOwn.value) {
                                AnalyticsController().logGameWon(false);
                                AnalyticsController().logScreen("Lost");
                                showDialog(
                                    context: context,
                          ...
                          IconButton(
                            onPressed: () async {
                              GoogleSignIn _googleSignIn = GoogleSignIn(
                                clientId:
                                    "957324502268-9i7n6du9mhecah70otrbde010gcda88a.apps.googleusercontent.com",
                                scopes: [
                                  'email',
